...
public class Lambda03 {
    public static void main(String[] args) {
        ...
        System.out.println("tumDaireKira5000denBuyukIseTrue(daireler) = " + tumDaireKira5000denBuyukIseTrue(daireler));
        System.out.println("\n *********");
        System.out.println("EnAzBirininKatSayisi2IseTrue(daireler) = " + EnAzBirininKatSayisi2IseTrue(daireler));
        System.out.println("\n *********");
        System.out.println("cephesiDoguOlanlarlarinSayisi(daireler) = " + cephesiDoguOlanlarlarinSayisi(daireler));
        System.out.println("\n *********");
        System.out.println("cephesiDoguOlanlarlarinSayisi(daireler) = " + KatSayisiniGoreBuyukucSir(daireler));

        System.out.println("\n *********");
        System.out.println("katSayisi2denFazlaOlanKiraGoreSirEnBuyukKirListYazdir(daireler) = " + KatSayisiniGoreBuyukucSir(daireler));
    }
...
// SORU2: Dairelerden En Az Birinin katSayisi 2 ise return ederek True yazdırın
    ...
    public static long cephesiDoguOlanlarlarinSayisi(List<Apartman> daireler) {
    ...
    public static List<Apartman> KatSayisiniGoreBuyukucSir(List<Apartman> daireler) {
    ...
    public static List<Integer> katSayisi2denFazlaOlanKiraGoreSirEnBuyukKirListYazdir(List<Apartman> daireler){
